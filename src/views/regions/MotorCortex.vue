      ...
      <div class="wrapper dark">
        ...
        <div class="text-container">
          <div class="content">
            ...
            <div class="section">
              <h3>Mapping of Motor Functions</h3>
              <img class="medium" src="/regions/motorcortex/motormapping.gif" alt="Mapping of the Motor Cortex" />
            </div>
            <h3 style="margin-bottom:-4rem">DTI Scans of the Motor Cortex</h3>
            <div class="section">
              <img class="medium" src="/regions/motorcortex/Coronal5.png" alt="DTI cutaway back" />
              <img class="medium" src="/regions/motorcortex/Sagittal5.png" alt="DTI cutaway side" />
            </div>
          </div>
        </div>
      </div>
